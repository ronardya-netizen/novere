...
const COPY = {
  fr: {
    ...
    heroSub: 'Novere fournit un compagnon d\'apprentissage unique aux enfants du primaire et du secondaire, dans un cadre engageant qui récompense chaque effort.',
    ...
    plans: [
      {
        ...
        feats: [
          ...
          { label: 'Accès complet au service de tutorat personnalisable', included: false },
      ...
      },
      {
        ...
        feats: [
          { label: '1 enfant', included: true },
          { label: 'Séances d\'étude illimitées', included: true },
          { label: 'Quêtes et articles éducatifs', included: true },
          { label: 'Boutique et liste de souhaits', included: true },
          { label: 'Accès complet au service de tutorat personnalisable', included: true },
      ...
      },
      {
        ...
        price: '39,99$',
        period: 'par mois · 1 enfant',
        description: 'Profitez d\'un rabais de 33% avec un abonnement annuel.',
        feats: [
          { label: '1 enfant', included: true },
 ...
 kr: {
  ...
  heroSub: 'Novere ofri timoun primè ak segondè yon konpay pou ede yo etidye, nan yon anvironman angajan ki rekonpanse chak efò.',
 ...
 plans: [
  {
    ...
    feats: [
      ...
      { label: '2 seyans etid pa jou', included: true },
      { label: 'Kèt ak atik edikasyon', included: true },
      { label: 'Boutik ak lis jwèt', included: true },
      { label: 'Aksè konplè a sèvis leson patikilye', included: false },
      { label: 'Sesyon san limit', included: false },
      { label: 'Rapò chak semèn pa imel', included: false },
  ...
  },
  {
    ...
    feats: [
      { label: '1 timoun', included: true },
      { label: 'Seyans etid san limit', included: true },
      { label: 'Kèt ak atik edikasyon', included: true },
      { label: 'Boutik ak lis dezire', included: true },
      { label: 'Aksè konplè a sèvis leson patikilye', included: true },
      { label: 'Rapò chak semèn pa imèl', included: true },
      { label: 'Sipò priyoritè', included: true },
    ],
    cta: 'Chwazi yon Plan Mansyèl →',
  ...
  },
  {
    name: 'Plan Anyèl',
    price: '39,99$',
    period: 'pa ane · 1 timoun',
    description: 'Jwi yon rabè de 33% ak yon abònman anyèl.',
    feats: [
      { label: '1 timoun', included: true },
      { label: 'Seyans etid san limit', included: true },
      { label: 'Kèt ak atik edikasyon', included: true },
